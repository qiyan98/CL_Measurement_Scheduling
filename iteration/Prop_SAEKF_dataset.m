...
function [X_Prop,P_Prop,Phi_Prop_SATEKF,Q_Prop] = Prop_SAEKF_dataset(X_hat_k,phi_est_in,P_k_single,Phi_k,k,sigma_V,sigma_phi)
%% load dt and N when this function is firstly used
persistent dt N fun_F fun_G dataset;
if isempty(N)
%     [~,~,~,N] = RobotInit();
    N = length(X_hat_k);
